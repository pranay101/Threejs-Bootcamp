...
bush1.scale.set(.5,.5,0.5)
bush1.position.set(.8,.2,2.2)

const bush2 = new THREE.Mesh(bushGeometry,bushMaterial)
bush2.scale.set(.25,.25,0.3)
bush2.position.set(1.4,.1,2.1)

const bush3 = new THREE.Mesh(bushGeometry,bushMaterial)
bush3.scale.set(.4,.4,0.4)
bush3.position.set(-0.8,.1,2.1)
...
const graveGeomentry = new THREE.BoxBufferGeometry(0.6,0.8,0.2)
...
const ghost3 = new THREE.PointLight("voilet",2,3)
...
const tick = () =>
{
    ...
    const ghost2Angle = -elapsedTime * 0.30
    ...
    ghost2.position.x = Math.sin(ghost3Angle) * (7 + Math.sin(elapsedTime * .32))
    ghost2.position.z = Math.sin(ghost3Angle) * (Math.sin(elapsedTime))
